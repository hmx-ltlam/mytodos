...
class TodoItem extends DataClass implements Insertable<TodoItem> {
  ...
  TodoItem copyWith(
          {int? id, String? title, String? subTitle, bool? isComplete}) =>
      TodoItem(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, title, subTitle, isComplete);
  @override
...
class $TodoItemsTable extends TodoItems
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, subTitle, isComplete];
  @override
